...
var defaultAlphabet = []rune("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-")
...
// Accepts optional parameter - length of the ID to be generated (24 by default).
